...
description: Run the repo's verification contract — check suite plus driving the changed surface on the real path; bootstraps the contract when absent. Use before design and after build.
---
